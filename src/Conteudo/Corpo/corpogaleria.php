...
<div class="site">
    <div id="carouselExample" class="carousel slide">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <iframe class="video" width="100%" height="600" src="https://www.youtube.com/embed/Vu1HFZ-8vII?enablejsapi=1&rel=0" title="Adega Lounge e Tabacaria Irmandade Localizado na rua Manoel Bueno da fonseca,46" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            <div class="carousel-item">
            <iframe class="video"   width="100%" height="600" src="https://www.youtube.com/embed/Kskj9xfO2CY?enablejsapi=1&rel=0" title="22 de setembro de 2023" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
